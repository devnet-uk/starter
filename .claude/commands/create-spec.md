...
<actions> 1. CHECK @docs/product/roadmap.md 2. FIND next uncompleted item 3. SUGGEST item to user 4. WAIT for approval
</actions>
</option_a_flow>
...
### Step 2: Context Gathering with Standards (Conditional)

Use the context-fetcher subagent to read product context and load relevant documentation standards for spec creation.

<conditional_logic>
IF both mission-lite.md AND tech-stack.md already read in current context:
SKIP product context loading
ELSE:
READ only files not already in context: - mission-lite.md (if not in context) - tech-stack.md (if not in context)

ALWAYS LOAD documentation standards: - REQUEST: "Consult the standards knowledge base for documentation and best-practices guidance. Start at the root dispatcher located at @docs/standards/standards.md and follow the routing logic to retrieve spec creation templates and documentation standards (e.g., documentation|spec|template)."
...
<documentation_standards>spec creation patterns and templates</documentation_standards>
<best_practices>architectural principles and guidelines</best_practices>
</context_analysis>
...
Use the file-creator subagent to create directory: docs/product/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file: docs/product/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: docs/product/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  ...
  <header>
    ...
    This is the technical specification for the spec detailed in @docs/product/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the database schema implementation for the spec detailed in @docs/product/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the API specification for the spec detailed in @docs/product/specs/YYYY-MM-DD-spec-name/spec.md
...
<step number="11" subagent="verification-runner" name="extract_verification_requirements">

### Step 11: Extract Verification Requirements

Use the verification-runner subagent to extract verification definitions from loaded standards and prepare verification plan for this feature specification.
...
<instructions>
  ...
  APPLY: Requirements to specification context for tasks creation
</instructions>

<verification_integration>
<extract> - Scan loaded standards for relevant verification blocks - Identify tests applicable to this feature - Collect variable requirements (PROJECT_COVERAGE, PROJECT_TYPE, etc.)
</extract>
<prepare> - Create verification checklist for this feature - Note dependency requirements between verification tests - Document expected validation points
</prepare>
<context> - Cache verification plan for use in create-tasks command - Include verification requirements in technical considerations - Prepare for execute-tasks verification integration
</context>
</verification_integration>
...
<review_request>
I've created the spec documentation with verification requirements:

- Spec Requirements: @docs/product/specs/YYYY-MM-DD-spec-name/spec.md
- Spec Summary: @docs/product/specs/YYYY-MM-DD-spec-name/spec-lite.md
- Technical Spec: @docs/product/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
  [LIST_OTHER_CREATED_SPECS]
- Verification Plan: [Extracted from loaded standards and cached for task creation]

Please review and let me know if any changes are needed.

When you're ready, run the /create-tasks command to have me build the tasks checklist from this spec with integrated verification requirements.
</review_request>
