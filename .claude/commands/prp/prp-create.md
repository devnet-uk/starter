# Create BASE Project Requirements Prompt (PRP)
...
The AI agent only gets the context you are appending to the PRP and its own training data. Assume the AI agent has access to the codebase and the same knowledge cutoff as you, so its important that your research findings are included or referenced in the PRP. The Agent has Websearch and Context7 MCP capabilities, so pass urls to documentation and examples.
...
2. **External Research at scale**
   ...
   - For critical pieces of documentation add a .md file to Docs/ai_docs and reference it in the PRP with clear reasoning and instructions
...
Using Docs/templates/prp_base_typescript.md as template:
